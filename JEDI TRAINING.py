...
# BLACK, ALMOND, PHLOX(pink?), BLUSH, RED, BLUE, WISTERIA(light purple ish), AMBER(yellow?), BRICK_RED and YELLOW.
...
# sh=400
#
# arcade.open_window(sw,sh,"Jerry Zheng")
...
# Center rectangle at (100, 520) with a width of 45 and height of 25, pixel border

# arcade.draw_rectangle_outline(100, 320, 45, 25, arcade.color.BLUSH,3)
import arcade
# y=260
